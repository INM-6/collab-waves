...
from jelephant.core import pick
...
selected_datasets = [
    ...
    ['i140703-001', 1],
    ['i140704-001', 1],
    # ['i140710-001', 1],  # isometric session!
    ['i140614-001', 1],  # replacement to not include isometric (but no spikes)
    ['i140718-001', 1],
    ['i140721-002', 1],
    ['i140725-002', 1],
    # ['i140801-001', 1],  # isometric session!
    ['i140620-001', 1],  # replacement to not include isometric (but no spikes)
    ['i141117-001', 1],
    ['i140917-002', 1],
    # 45-59: Lilou Cnd 2
    ['l101013-005', 2],
